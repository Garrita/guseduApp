...
public class Visita  implements java.io.Serializable {
    ...
    public Visita(Cliente cliente, Double visCostoTotal, Boolean visPresencial, Integer visEstado, Date visFecCreacion, Integer visPrioridad, String visUsuCreacion, String visDescripcion, Date visFecFin, Boolean visLlegada, Set enfermedadVisitas, Set sintomaVisitas, Set productoVisitas, Set terapias, Set terapias_1, Set pagos, Set productoVisitas_1, Set enfermedadVisitas_1, Set sintomaVisitas_1, Set historiaClinicas, Set historiaClinicas_1) {
       this.cliente = cliente;
    ...
    public Boolean getVisLlegada() {
        return this.visLlegada;
    }
